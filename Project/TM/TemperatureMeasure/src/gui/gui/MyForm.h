...
#pragma endregion
	private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->baudRateOptions->SelectedIndex = 4;
		...
		array<Object^>^ parity = { "None", "Even", "Odd", "Mark", "Space" };
	...
	private: System::IO::Ports::Parity ParityParseStringToEnum(System::String^ string)
	{
		...
		if (string == "Mark") return System::IO::Ports::Parity::Mark;
		if (string == "Space") return System::IO::Ports::Parity::Space;
